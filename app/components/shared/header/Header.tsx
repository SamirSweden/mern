                ...
                <div className="max-w-307.5 px-4 md:px-6 mx-auto w-full h-full">
                    ...
                    inset-0`}>
                            ...
                            <div className="header__apps  flex flex-col gap-[10px] !px-5 items-center justify-center fixed bottom-7 left-0 w-full mx-3 ">
                                <button onClick={() => router.push('/sign-in')} className="login  bg-yellow-400 py-[20px] px-[20px] w-full outline-none border-none  cursor-pointer  w-full rounded-xl text-black capitalize ">
                                    login
                                </button>
                            </div>
                        </div>
