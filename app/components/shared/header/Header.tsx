            ...
            <header className={'header py-5 px-0 sticky left-0 top-0 w-full   shadow-[inset_4px_4px_30px_0_hsla(0,0%,100%,.15)]'}>
                <div className="max-w-307.5 px-4 md:px-6 mx-auto w-full h-full">
                    <div className="flex items-center justify-between">
                        ...
                        <div className={`${isOpen ? "translate-x-0" : "translate-x-full"} flex items-center justify-center flex-col fixed left-0 z-40 backdrop-blur-xl
                     bg-gradient-to-br  from-black via-black to-red-500 transition-transform duration-300
                    inset-0`}>
