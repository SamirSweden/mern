            ...
            <div className="max-w-307.5 mx-auto md:px-6 px-4 w-full h-full">
                <div className="grid grid-cols-2 gap-6  max-[768px]:grid-cols-1 ">
                    <div className={'flex items-center gap-4 flex-col'}>
                        ...
                        <Link href={'/polygon'} className={'py-4 px-5 shadow-2xl shadow-gray-500 bg-white text-black hover:bg-[#171717] hover:text-white w-full rounded-2xl text-center'}>{bannerContent.btnText}</Link>
                    </div>
